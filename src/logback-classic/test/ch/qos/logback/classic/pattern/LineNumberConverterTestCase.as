package ch.qos.logback.classic.pattern {
	 ...
	 */
	public class LineNumberConverterTestCase {
		
		private var reference:LineNumberConverter;
		
		[Before]
		public function setup():void {
			this.reference = new LineNumberConverter();
		}
...
//			if their line numbers change, they fail.
		...
		public function testIsLogbackObject():void {
			...
			Assert.assertTrue("Failed to return 'true' for AbstractPatternLayoutProcessor.",
				this.reference.isLogbackObject(AbstractConverter));
				
			Assert.assertFalse("Failed to return 'false' for a non-logback-object.",
				this.reference.isLogbackObject(LineNumberConverterTestCase));
		}
	}
}
