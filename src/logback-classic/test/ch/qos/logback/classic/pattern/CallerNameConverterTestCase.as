package ch.qos.logback.classic.pattern {
	 ...
	 */
	public class CallerNameConverterTestCase {
		
		private var reference:CallerNameConverter;
		...
		public function setup():void {
			this.reference = new CallerNameConverter();
		...
		public function testGetDefinition():void {
			Assert.assertEquals("Failed to get the definition for 'ch.qos.logback.classic.pattern.CallerNamePatternLayoutProcessor'.",
				CallerNameConverter, this.reference.getDefinition(
					'at ch.qos.logback.classic.pattern::CallerNameConverter/apply()'));
		...
		public function testIsLogbackObject():void {
			...
			Assert.assertTrue("Failed to recognize an implementor of 'ch.qos.logback.classic.pattern.PatternLayoutProcessor' as a logback object.",
				this.reference.isLogbackObject(CallerNameConverter));
...
class MockLayout extends AbstractLayout {
	...
	private var processor:Converter;
	
	private var _pattern:String;
	
	public function MockLayout(processor:Converter = null, pattern:String = null) {
		super("mockLayout");
