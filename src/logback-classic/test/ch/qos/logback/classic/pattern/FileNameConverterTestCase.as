package ch.qos.logback.classic.pattern {
	 ...
	 */
	public class FileNameConverterTestCase {
		
		private var reference:FileNameConverter;
		...
		public function setup():void {
			this.reference = new FileNameConverter();
		...
		public function testApply():void {
			var regex:RegExp = new RegExp("ch/qos/logback/classic/pattern/FileNameConverterTestCase\\.as$");
...
import ch.qos.logback.classic.pattern.FileNameConverter;
...
class MockLayout extends AbstractLayout {
	...
	private var fileNameProcessor:FileNameConverter;
	
	private var _pattern:String;
	
	public function MockLayout(processor:FileNameConverter) {
